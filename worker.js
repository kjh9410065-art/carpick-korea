...
<url><loc>https://mingka.tcflick.com/affiliate.html</loc><lastmod>2026-09-09</lastmod><changefreq>monthly</changefreq><priority>0.5</priority></url>
    ...
    // 새 MINGKA 아이콘을 모든 HTML 페이지의 브라우저 탭/홈 화면 아이콘으로 적용합니다.
    const iconTags = '<link rel="icon" href="/favicon.jpg" type="image/jpeg" />\n<link rel="apple-touch-icon" href="/favicon.jpg" />';
    if (!/<link\s+rel=["']icon["'][^>]*favicon\.jpg/i.test(html)) {
      html = html.replace(/<head>/i, `<head>\n${iconTags}`);
    }
